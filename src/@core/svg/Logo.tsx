...
const logoUrl = process.env.NEXT_PUBLIC_LOGO_URL || '/images/logos/logo.png'

const Logo = (props: Omit<React.ComponentProps<typeof Image>, 'src'>) => <Image src={logoUrl} {...props} />
